...
- [`docs/superpowers/plans/2026-06-29-performance-optimization.md`](docs/superpowers/plans/2026-06-29-performance-optimization.md) turns that research into a goal, phased implementation plan, and verification metrics for the next performance optimization cycle (Korean HTML companion: [`docs/superpowers/plans/2026-06-29-performance-optimization.ko.html`](docs/superpowers/plans/2026-06-29-performance-optimization.ko.html)).
- [`docs/performance-optimization-implementation-2026-06-29.md`](docs/performance-optimization-implementation-2026-06-29.md) records the first execution pass: the 8 verified changes shipped to deployment target (Tier 1), live post-deploy verification, post-review fixes, and the design-risk items deliberately deferred with their gating rationale (Korean HTML companion: [`docs/performance-optimization-implementation-2026-06-29.ko.html`](docs/performance-optimization-implementation-2026-06-29.ko.html)).
- [`docs/deferred-performance-opportunities-2026-06-29.md`](docs/deferred-performance-opportunities-2026-06-29.md) summarizes the deferred optimization opportunities, their dependencies, expected benefits, and recommended next-pass order (Korean HTML companion: [`docs/deferred-performance-opportunities-2026-06-29.ko.html`](docs/deferred-performance-opportunities-2026-06-29.ko.html)).
