...
my @modules = (
    ...
    "LANraragi::Utils::Generic",                 "LANraragi::Utils::ImageResponse",
    "LANraragi::Utils::Plugins",                 "LANraragi::Utils::Routing",
    "LANraragi::Utils::Tachiyomi",               "LANraragi::Utils::TempFolder",
    "LANraragi::Utils::Logging",                 "LANraragi::Utils::OpenAPI",
    "LANraragi::Utils::Minion",                  "LANraragi::Utils::Minion::Dedup",
    "LANraragi::Utils::Minion::PageSide",        "LANraragi::Utils::Minion::Tachiyomi",
    "LANraragi::Utils::PageSide",
