...
Once you have created a Category, you can add Archives to it through the right-click menu in the Index, or in the setting page directly.
...
{% hint style="info" %}
If you delete the Category that is currently linked to the bookmark feature, the bookmark functionality will be automatically disabled.
{% endhint %}
