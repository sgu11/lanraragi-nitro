...
- **완독 progress 보존**: 마지막 page에 도달하면 synced reading progress를 pagecount로 유지해 Library의 읽음 표시와 hide-completed 동작을 보존함. 현재 reader session URL은 마지막 page를 유지하지만, library에서 archive를 다시 열면 page 1에서 시작함.
