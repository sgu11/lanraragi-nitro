...
export function drawCallback() {
    if (typeof (dataTable) !== "undefined") {
        Perf.measure("index.draw", () => {
            ...
            const currentSort = dataTable.settings()[0].aoColumns[sortColumn]?.sName || "title";
...
export function consumeURLParameters() {
    ...
    const order = getInitialIndexOrder(
        params,
        localStorage,
        currentCustomColumnCount,
        dataTable.settings()[0].aoColumns,
    );
